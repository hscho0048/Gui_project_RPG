...
public class HomeView extends JPanel {
	...
	public void updateRanking() {
		...
		if (rs == null) {
			PopupLabelUtil.showPopupLabel(this, "랭킹 데이터를 불러오는 중 오류가 발생했습니다.", "failSymbol.png");
			return;
		}
		...
		try {
			...
			if (!hasData) {
				PopupLabelUtil.showPopupLabel(this, "아직 플레이한 사용자가 없습니다.", "failSymbol.png");
			}
		} catch (SQLException e) {
			throw new RuntimeException("렝킹 데이터 처리 중 오류", e);
		}
	}
}
